...
// Function for clearing all needed elements
function clear() {
...
// Function for refreshing history
function refresh() {
    if(!localStorage.getItem("day_history"))  {
        history2 = [];
    } 
...
function stats() {   
    ...
    scores.insertAdjacentHTML("beforeend",  "<b> Today's score: " + today_score + "/" + today_possible + "</b> <br>" + "<b> This week's score: " + thisweek_score + "/" + thisweek_possible + "</b> <br>" + "<b> Total score: " + score_total);
...
function dayview(number, number2) {  
    ...
    // Creating eventlisterers for tasks
...
// Function for going back to month view
...
// Creating swipe action to swipe next or previous month
